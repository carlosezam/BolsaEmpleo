...
class LoginForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            // username es validad por validateAdmin
    ...
    public function validateAdmin($attribute, $params)
    {
        if(!$this->hasErrors())
        {
            ...
            if( !$user || !in_array( (string)$user->id, $admins ) )
            {
                $this->addError($attribute, 'El usuario no es administrador');
            }
        }
    }
    ...
    public function getUser()
    {
        if ($this->_user === false) {
            ...
            $this->_user = Usuario::findByUsernameOrEmail($this->username);
        }
