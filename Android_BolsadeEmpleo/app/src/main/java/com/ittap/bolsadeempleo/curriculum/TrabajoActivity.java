...
public class TrabajoActivity extends AppCompatActivity {
    ...
    {
        empresa.setEnabled( editable );
        puesto.setEnabled( editable );
        actividades.setEnabled( editable );
    ...
    {
        empresa = (EditText)findViewById(R.id.trabajo_empresa);
        puesto = (EditText)findViewById(R.id.trabajo_puesto);
        actividades = (EditText)findViewById(R.id.trabajo_actividades);
        fecha_ini = (EditText)findViewById(R.id.trabajo_fecha_ini);
        fecha_fin = (EditText)findViewById(R.id.trabajo_fecha_fin);

        btnGuardar = (Button) findViewById(R.id.trabajo_btn_guardar);
        btnCancelar = (Button) findViewById(R.id.trabajo_btn_cancelar);

        editTextHashMap = new HashMap<>();
        editTextHashMap.put("empresa", empresa);
        editTextHashMap.put("puesto", puesto);
        editTextHashMap.put("actividades", actividades);
    ...
    protected void get_form_data() {
        data.empresa = empresa.getText().toString();
        data.puesto = puesto.getText().toString();
        data.actividades = actividades.getText().toString();
        data.fecha_ini = fecha_ini.getText().toString();
        data.fecha_fin = fecha_fin.getText().toString();
    }

    protected void put_form_data( Trabajo data )
    {
        empresa.setText(data.empresa);
        puesto.setText( data.puesto);
        actividades.setText(data.actividades);
